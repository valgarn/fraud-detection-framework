CC := g++
CFLAGS := -c -fPIC -DBUILDING_FDF_LIB -Wall -I/root/anaconda3/include -I/root/anaconda3/include/python3.6m \
            -I./include -I/usr/local/include \
            -L../lib -L/usr/local/lib -L/root/anaconda3/lib -L/root/anaconda3 -std=c++11 \
			-lpython3.6m -lboost_python3-py36 -lboost_numpy3-py36\
            -ljpeg \
            -lexif \
            -lopencv_calib3d \
            -lopencv_core \
...
LDFLAGS := -shared -fPIC -std=c++11 \
            -L/usr/local/lib -L../lib -L/root/anaconda3/lib -L/root/anaconda3 \
			-lpython3.6m  -lboost_python3-py36 -lboost_numpy3-py36\
            -ljpeg \
			-lexif \
			-lopencv_calib3d \
