CC := g++
CFLAGS := -c -fPIC -DBUILDING_FDF_LIB -Wall -I/usr/include/ -I/root/anaconda3/include/python3.6m/ \
            -I./include -I/usr/local/include/  -std=c++11
LDFLAGS := -shared -fPIC -std=c++11 \
            -L/usr/local/lib -L../lib -L/Users/val/Projects/FDF/MacOS/boost_1_69_0/stage/lib \
